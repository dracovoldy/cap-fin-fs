		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comchevrondcorediaaanalyticsvariables-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comchevrondcorediaaanalyticsvariables-display": {
								"semanticObject": "comchevrondcorediaaanalyticsvariables",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.chevron.dcore.diaa.analyticsvariables",
									"url": sap.ui.require.toUrl("com/chevron/dcore/diaa/analyticsvariables")
								}
							}
						}
					}
